...
def main():
    ...
    if (args.save_model):
        torch.save(model.state_dict(),
                   "/home/Drive2/amil/my_network/pt_files/file: train_acc:" + str(train_acc) + " test-acc:" + str(
                       test_acc) + " epochs: " + str(args.epochs) + "Breakthis_state_dict.pt")
        torch.save(model,
                   "/home/Drive2/amil/my_network/pt_files/file: train_acc:" + str(train_acc) + " test-acc:" + str(
                       test_acc) + " epochs: " + str(args.epochs) + "Breakthis_model.pt")
    save_name_pkl = "/home/Drive2/amil/my_network/pickel_files/file: train_acc:" + str(train_acc) + " test-acc:" + str(
        test_acc) + " epochs: " + str(args.epochs) + " end.pkl"
    save_name_txt = "/home/Drive2/amil/my_network/txt_file/file: train_acc:" + str(train_acc) + " test-acc:" + str(
        test_acc) + " epochs: " + str(args.epochs) + " end.txt"
